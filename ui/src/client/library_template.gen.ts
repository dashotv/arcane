...
import { arcaneClient, Setting, LibraryTemplate, Response } from ".";
...
export const LibraryTemplateIndex = async (
  params: LibraryTemplateIndexRequest,
) => {
  const response = await arcaneClient.get(
    `/library_template/?page=${params.page}&limit=${params.limit}`,
  );
...
export const LibraryTemplateCreate = async (
  params: LibraryTemplateCreateRequest,
) => {
  const response = await arcaneClient.post(
    `/library_template/?`,
    params.subject,
  );
...
export const LibraryTemplateShow = async (
  params: LibraryTemplateShowRequest,
) => {
  const response = await arcaneClient.get(`/library_template/${params.id}?`);
...
export const LibraryTemplateUpdate = async (
  params: LibraryTemplateUpdateRequest,
) => {
  const response = await arcaneClient.put(
    `/library_template/${params.id}?`,
    params.subject,
  );
...
export const LibraryTemplateSettings = async (
  params: LibraryTemplateSettingsRequest,
) => {
...
export const LibraryTemplateDelete = async (
  params: LibraryTemplateDeleteRequest,
) => {
  const response = await arcaneClient.delete(`/library_template/${params.id}?`);

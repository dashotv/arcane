...
import { arcaneClient, Setting, LibraryType, Response } from ".";
...
export const LibraryTypeIndex = async (params: LibraryTypeIndexRequest) => {
  const response = await arcaneClient.get(
    `/library_type/?page=${params.page}&limit=${params.limit}`,
  );
...
export const LibraryTypeCreate = async (params: LibraryTypeCreateRequest) => {
  const response = await arcaneClient.post(`/library_type/?`, params.subject);
...
export const LibraryTypeShow = async (params: LibraryTypeShowRequest) => {
  const response = await arcaneClient.get(`/library_type/${params.id}?`);
...
export const LibraryTypeSettings = async (
  params: LibraryTypeSettingsRequest,
) => {
...
export const LibraryTypeDelete = async (params: LibraryTypeDeleteRequest) => {
  const response = await arcaneClient.delete(`/library_type/${params.id}?`);

...
func setupWorkers(app *Application) error {
	...
	if err := minion.Register[*LibraryFiles](m, &LibraryFiles{}); err != nil {
...
//		events.Send("arcane.jobs", &EventJob{"created", j.ID.Hex(), j})
//		return
//	}
//	events.Send("arcane.jobs", &EventJob{"updated", j.ID.Hex(), j})
//}
